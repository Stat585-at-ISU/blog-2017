...
The most commonly used objects in R are S3 objects. An S3 object is an R object with a "class" attribute. In S3, the methods belongs to generic functions not objects or classes. The process of calling the a method by using generic functions is called Method Dispatching.
