...
In both the papers the researchers discuss about WaveLab- Reproducible Research via the Internet. WaveLab is a library of MATLAB, developed, designed and released by researcher’s around1995 and the paper was published in the year 1995. This was primarily developed to reproduce all the figures that were published in wavelet articles. This package has varied tools for wavelet and time-frequency transforms. This tool allows all the other researchers to reproduce the images, tables that are published. 
